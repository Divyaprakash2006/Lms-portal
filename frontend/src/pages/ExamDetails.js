        ...
        <div style={{
          ...
          {exam.assignedStudents && exam.assignedStudents.length > 0 && (
            <div style={{ 
              ...
              <strong>Assigned Students:</strong> {exam.assignedStudents.length}
            </div>
          )}
        </div>
          ...
          {questions.length === 0 ? (
            ...
            questions.map((question, index) => (
              <div key={question._id} style={{
                ...
                {/* Show correct answer for trainers/admins */}
                {(user?.role === 'trainer' || user?.role === 'admin') && question.correctAnswer && (
                  <div style={{
                    marginTop: '10px',
                    padding: '10px',
                    backgroundColor: '#d4edda',
